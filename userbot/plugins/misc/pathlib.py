...
@userbot.on_cmd("dclear", about={'header': "Clear the current working directory"})
...
@userbot.on_cmd(r'split (\d+) ([\s\S]+)', about={
    'header': "Split files",
