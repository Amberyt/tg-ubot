...
from userbot.utils import time_formatter, humanbytes
...
@userbot.on_cmd("ytinfo", about={'header': "Get info from ytdl",
...
@userbot.on_cmd("ytdl", about={'header': "Download from youtube",
...
@userbot.on_cmd("ytdes", about={'header': "Get the video description",
                               'description': 'Get information of the link without downloading',
