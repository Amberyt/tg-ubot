...
async def gban_user(message: Message):
    ...
    get_mem = await userbot.get_user_dict(user_id)
...
@userbot.on_cmd("whitelist", about={
...
@userbot.on_cmd("listwhite", about={
